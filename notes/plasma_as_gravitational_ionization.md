> **Provenance.**  This note is reproduced verbatim from Paper~I of
> the A=1 Discrete Causal Lattice series
> ([doi:10.5281/zenodo.20078529](https://doi.org/10.5281/zenodo.20078529))
> as the theoretical companion to the inherited
> `src/experiments/exp_18_tidal_ionization.py` script.
> Cross-references to Paper~I's own paper sections
> (e.g. §8, §8.8) refer to Paper~I's manuscript, not Paper~III's.
> Section numbers in Paper~III's manuscript are independent.
